...
категорию новости нужно сделать так Выбери НАИБОЛЕЕ подходящую категорию (от 1 до 6 а это категории 1: #news,2: #visa,3:#life,4:#spanish,5:#tourism,6:#family) для этой новости. Если новость не подходит ни под одну из категорий, верни null и помести эту новость в 3 #life.
1: #news Важные Новости и Налоги — Официально: Законы из BOE, налоги (Modelo 100/721), банковские лимиты.
    Налоги, банковские законы, жилье и аренда , забастовки , транспортный сектор
...
3:#life Жизнь и История — Праздники, культура, интересные факты, история регионов.
...
6:#family Семья и Здоровье — Школы, садики, запись к врачам (SIP), пособия и страховки.
    ...
    4. Пособия и Социальная помощь (Ayudas y Subvenciones)
